...
const Contact = () => {
    ...
    return (
        <section id="contact" ref={containerRef} className="py-32 relative overflow-hidden bg-[#020408]">
            {/* Ambient Lighting */}
                ...
                <div className="max-w-6xl mx-auto relative">
                    ...
                    <div className="hidden lg:block absolute left-1/2 -translate-x-1/2 top-[-128px] h-[350px] w-[2px] bg-white/5 z-0">
                        ...
                        >
                            ...
                            <motion.div
                                className="absolute bottom-0 left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-digital-primary shadow-[0_0_20px_rgba(255,215,0,0.8)] border-2 border-[#020408] translate-y-1/2"
                            />
                        </motion.div>
                    </div>

                    <div className="grid lg:grid-cols-2 gap-16 item-center relative z-10">
